<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="coding2.aspx.cs" Inherits="CoderWebApplication.WebFormcode02" %>
                            ...
                            <form id="form1" class="block-content form"  defaultbutton="Button1" runat="server">
                                <asp:Panel ID="A21" runat="server">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="_50">
                                            <p>
                                                <label for="textfield1">A22a</label>
                                                <asp:TextBox ID="A22a" runat="server" disabled="true" CssClass="supp_text" TextMode="MultiLine" style="resize:none" ToolTip="A22a. Who is (NAME) working for? What is the name of the company, if it has a name?"></asp:TextBox>
                                            </p>
                                        </div>

                                        <div class="_50">
                                            <p>
                                                <label for="textfield2">A22b</label>
                                                <asp:TextBox ID="A22b" runat="server" disabled="true" CssClass="supp_text" TextMode="MultiLine" style="resize:none" ToolTip="A22b. What is produced / cultivated / mined / done where (NAME) works or what does (NAME) produce / cultivate / do?"></asp:TextBox>
                                            </p>
                                        </div>
                                        <div class="_50">
                                            <p>
                                                <label for="textfield1">A23</label>
                                                <asp:TextBox ID="A23" runat="server" disabled="true" CssClass="supp_text" TextMode="MultiLine" style="resize:none" ToolTip="A23. Where did (NAME) carry out his/her main work during the past week?"></asp:TextBox>
                                            </p>
                                        </div>

                                        <div class="_50">
                                            <p>
                                                <label for="textfield2">A24</label>
                                        ...
                                        <div class="_50">
                                            <p>
                                                <label for="textfield1">A21a</label>
                                                <asp:TextBox ID="TextBox7" runat="server" disabled="true" CssClass="act_text" TextMode="MultiLine" style="resize:none" ToolTip="A21a. What would you call (NAME)'s occupation?"></asp:TextBox>
                                            </p>
                                        </div>

                                        <div class="_50">
                                            <p>
                                                <label for="textfield2">A21b</label>
                                                <asp:TextBox ID="TextBox8" runat="server" disabled="true" CssClass="act_text" TextMode="MultiLine" style="resize:none" ToolTip="A21b. What does (NAME) usually do during his/her worktime in this job/task? "></asp:TextBox>
                                            </p>
                                        </div>

                                        <div class="_25">
                                            <p>
                                                <label for="textfield2">Major Group</label>
                                                <asp:TextBox ID="MajorFilter1" runat="server" Style="height: 8px"></asp:TextBox>
                                                <asp:ListBox ID="ListBox4_a"  style="height:150px !important" runat="server"></asp:ListBox>
                                            </p>
                                        </div>
                                        <div class="_25">
                                            <p>
                                                <label for="textfield2">Sub-Major Group</label>
                                                <asp:ListBox ID="ListBox4_b" runat="server"  style="height:150px !important"></asp:ListBox>
                                            </p>
                                        </div>
                                        <div class="_25">
                                            <p>
                                                <label for="textfield2">Minor Group</label>
                                                <asp:ListBox ID="ListBox4_c" runat="server"  style="height:150px !important"></asp:ListBox>
                                            </p>
                                        </div>
                                        <div class="_25">
                                            <p>
                                                <label for="textfield2">Unit Group</label>
                                                <asp:ListBox ID="ListBox4_d" runat="server"  style="height:150px !important"></asp:ListBox>
                                            </p>
                                        </div>
                                        <div class="_25">
                                            <p>
                                                <label>
                                                    <div class="radio"><span>
                                                        <input type="radio" id="radio4_a" value="3999" name="radio4" style="opacity: 0;"></span></div>
                                                    Industry/Occupation mismatch</label>
                                                <label>
                                                    <div class="radio"><span>
                                                        <input type="radio" id="radio4_b" value="3998" name="radio4" style="opacity: 0;"></span></div>
                                                    Unclear Text</label>
                                            </p>
                                        </div>
                                        <div class="_50">
                                            <p>
                                                <label for="textfield1">Code</label>
                                        ...
                                        A21b_3 A21b. What does ${NameFromEarlierA} usually do during his/her worktime in this job/task? (Clarify if needed with the question: What does ${NameFromEarlierA} do at work? What are the activities/actions that ${NameFromEarlierA} carries out?"></asp:TextBox>
                                            </p>
                                        </div>
                                ...
                                <asp:Panel ID="A43" runat="server">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="_100">
                                            <p>
                                                <label for="textfield1" class="supp_label">A45</label>
                                        ...
                                        <div class="_50">
                                            <p>
                                                <label for="textfield1" class="supp_label">A44a</label>
                                                <asp:TextBox ID="A44a" runat="server" disabled="true" CssClass="supp_text" TextMode="MultiLine" style="resize:none" ToolTip="A44a. Who is (NAME) working for? What is the name of the company, if it has a name?  "></asp:TextBox>
                                            </p>
                                        </div>

                                        <div class="_50">
                                            <p>
                                                <label for="textfield2" class="supp_label">A44b</label>
                                                <asp:TextBox ID="A44b" runat="server" disabled="true" CssClass="supp_text" TextMode="MultiLine" style="resize:none" ToolTip="A44b. What is produced / cultivated / mined / done where (NAME) works or what does (NAME) produce / cultivate / do?"></asp:TextBox>
                                            </p>
                                        </div>
                                        <div class="_50">
                                            <p>
                                                <label for="textfield1" class="act_label">A43a</label>
                                                <asp:TextBox ID="TextBox9" runat="server" disabled="true" CssClass="act_text" TextMode="MultiLine" style="resize:none" ToolTip="A43a. What would you call (NAME)'s occupation? Please describe it like 'I am a … and I work at/in/for …'. Please also say with what (NAME) works, if informative (E.g. 'I am a taxi driver and I work for a Hotel', 'I am a labourer and I wokd on a rice field for a land owner') "></asp:TextBox>
                                            </p>
                                        </div>

                                        <div class="_50">
                                            <p>
                                                <label for="textfield2" class="act_label">A43b</label>
                                        ...
                                        <div class="_25">
                                            <p>
                                                <label for="textfield2">Sub-Major Group</label>
                                                <asp:ListBox ID="ListBox5_b" runat="server"  style="height:150px !important"></asp:ListBox>
                                            </p>
                                        </div>
                                        <div class="_25">
                                            <p>
                                                <label for="textfield2">Minor Group</label>
                                                <asp:ListBox ID="ListBox5_c" runat="server"  style="height:150px !important"></asp:ListBox>
                                            </p>
                                        </div>
                                        <div class="_25">
                                            <p>
                                                <label for="textfield2">Unit Group</label>
                                                <asp:ListBox ID="ListBox5_d" runat="server"  style="height:150px !important"></asp:ListBox>
                                            </p>
                                        </div>
                                        <div class="_25">
                                            <p>
                                                <label>
                                                    <div class="radio"><span>
                                                        <input type="radio" id="radio5_a" value="3999" name="radio5" style="opacity: 0;"></span></div>
                                                    Industry/Occupation mismatch</label>
                                                <label>
                                                    <div class="radio"><span>
                                                        <input type="radio" id="radio5_b" value="3998" name="radio5" style="opacity: 0;"></span></div>
                                                    Unclear Text</label>
                                            </p>
                                        </div>
                                        <div class="_50">
...
A43b_4 A43b. What does ${NameFromEarlierA} usually do during his/her worktime in this job/task? (Clarify if needed with the question: What does ${NameFromEarlierA} do at work? What are the activities/actions that ${NameFromEarlierA} carries out?"></asp:TextBox>
                                            </p>
                                        </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="_50">
                                            <p>
                                                ...
                                                <asp:TextBox ID="C21a" runat="server" disabled="true" CssClass="supp_text" TextMode="MultiLine" style="resize:none" ToolTip="C21a. Who are you working for? What is the name of the company, if it has a name?"></asp:TextBox>
                                            </p>
                                        </div>
                                        <div class="_50">
                                            <p>
                                                <label for="textfield1">C21b</label>
                                                <asp:TextBox ID="C21b" runat="server" disabled="true" CssClass="supp_text" TextMode="MultiLine" style="resize:none" ToolTip="C21b. What is produced / cultivated / mined / done where you work or what do you produce / cultivate / do? (Clarify if needed with: What is the final outcome of (NAME)'s work?)"></asp:TextBox>
                                            </p>
                                        </div>
                                        <div class="_50">
                                            <p>
                                                <label for="textfield1">C25</label>
                                                <asp:TextBox ID="C25" runat="server" disabled="true" CssClass="supp_text" TextMode="MultiLine" style="resize:none" ToolTip="C25. Where did you carry out your main work during the past week?"></asp:TextBox>
                                            </p>
                                        </div>
                                          <div class="_50">
                                            <p>
								...
								<p><label for="textfield2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    <asp:label ID="C32" runat="server" Visible="true" disabled="true" CssClass="act_text" TextMode="MultiLine" style="resize:none" ToolTip="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"></asp:label></p>
							</div>--%>
                                        ...
                                        <div class="_25">
                                            <p>
                                                <label for="textfield2">Sub-Major Group</label>
                                                <asp:ListBox ID="ListBox6_b" runat="server"  style="height:150px !important"></asp:ListBox>
                                            </p>
                                        </div>
                                        <div class="_25">
                                            <p>
                                                <label for="textfield2">Minor Group</label>
                                                <asp:ListBox ID="ListBox6_c" runat="server"  style="height:150px !important"></asp:ListBox>
                                            </p>
                                        </div>
                                        <div class="_25">
                                            <p>
                                                <label for="textfield2">Unit Group</label>
                                                <asp:ListBox ID="ListBox6_d" runat="server"  style="height:150px !important"></asp:ListBox>
                                            </p>
                                        </div>
                                        <div class="_25">
                                            <p>
                                                <label>
                                                    <div class="radio"><span>
                                                        <input type="radio" id="radio6_a" value="3999" name="radio6" style="opacity: 0;"></span></div>
                                                    Industry/Occupation mismatch</label>
                                                <label>
                                                    <div class="radio"><span>
                                                        <input type="radio" id="radio6_b" value="3998" name="radio6" style="opacity: 0;"></span></div>
                                                    Unclear Text</label>
                                            </p>
                                        </div>
                                        <div class="_50">
...
C20b_10_1017 C20b. What do you usually do during your worktime in this job/task? "></asp:TextBox>
                                            </p>
                                        </div>
                                ...
                                <asp:Panel ID="C35_P" runat="server">
                                    <fieldset>
                                        ...
                                        <div class="_100">
                                            <p>
                                                <label for="textfield1">C35</label>
                                                <asp:TextBox ID="C35_Text" runat="server" disabled="true" CssClass="act_text" TextMode="MultiLine" style="resize:none" ToolTip="C35. Think about your most serious illness/injury, what were you doing when this happened?"></asp:TextBox>
                                            </p>
                                        </div>
                                        ...
                                        <div class="_25">
                                            <p>
                                                <label for="textfield2">Major Group</label>
                                                <asp:TextBox ID="MajorFilter4" runat="server" Style="height: 8px"></asp:TextBox>
                                        ...
                                        <div class="_25">
                                            <p>
                                                <label for="textfield2">Sub-Major Group</label>
                                                <asp:ListBox ID="C35_SMj" runat="server"  style="height:150px !important"></asp:ListBox>
                                            </p>
                                        </div>
                                        <div class="_25">
                                            <p>
                                                <label for="textfield2">Minor Group</label>
                                                <asp:ListBox ID="C35_Min" runat="server"  style="height:150px !important"></asp:ListBox>
                                            </p>
                                        </div>
                                        <div class="_25">
                                            <p>
                                                <label for="textfield2">Unit Group</label>
                                                <asp:ListBox ID="C35_U" runat="server"  style="height:150px !important"></asp:ListBox>
                                            </p>
                                        </div>
                                        <div class="_25">
                                            <p>
                                                <label>
                                                    <div class="radio"><span>
                                                        <input type="radio" id="C35_R" value="3999" name="radio3" style="opacity: 0;"></span></div>
                                                    Industry/Occupation mismatch</label>
                                                <label>
                                                    <div class="radio"><span>
                                                        <input type="radio" id="C35_RB" value="3998" name="radio3" style="opacity: 0;"></span></div>
                                                    Unclear Text</label>
                                            </p>
                                        </div>
                                        <div class="_50">
                                            <p>
                                                <label for="textfield1">Code</label>
                                                <asp:TextBox ID="C35_Code" runat="server" ToolTip="C35. Think about your most serious illness/injury, what were you doing when this happened?"></asp:TextBox>
                                            </p>
                                        </div>
                                ...
                                <div class="block-actions">
                                    ...
                                    <ul class="actions-right">
                                     ...
                                     <asp:Button ID="Button1" runat="server" OnClick="Button1_Click"  Height="25px" UseSubmitBehavior="false" OnClientClick="this.disabled='true'; this.value='Please wait...'; __doPostBack('Button1','')"  type="submit" class="button" Text="Save Code & Next" />
                                            ...
                                            <%--<asp:Button ID="Button1" runat="server" OnClientClick="disableClick(this)" OnClick="Button1_Click" type="submit" class="button" Text="Save Code & Next" />--%>
                                        </li>
                                    </ul>
                                </div>
                            </form>
    ...
    <!-- Tooltips -->
    <script defer src="js/mylibs/excanvas.js"></script>
    <!-- Charts -->
    ...
    <script type="text/javascript">
        opts = document.getElementById("ListBox4_a").getElementsByTagName("option")
        for (var k = 0; k < opts.length; k++) {
            opts[k].title = opts[k].text
        }
        opts2 = document.getElementById("ListBox5_a").getElementsByTagName("option")
        for (var k = 0; k < opts2.length; k++) {
            opts2[k].title = opts2[k].text
        }
        opts3 = document.getElementById("ListBox6_a").getElementsByTagName("option")
    ...
    <script type="text/javascript">
        $().ready(function () {
            ...
            var keys = [];
            var values = [];
            var options = $('#<% = ListBox4_a.ClientID %> option');
        ...
        $('#<% = MajorFilter1.ClientID %>').keyup(function () {
          var filter = $(this).val();
          DoListBoxFilter('#<% = ListBox4_a.ClientID %>', filter, keys, values);

      });
	    var keys2 = [];
	    var values2 = [];
	    var options2 = $('#<% = ListBox5_a.ClientID %> option');
        ...
        $('#<% = MajorFilter2.ClientID %>').keyup(function () {
            var filter = $(this).val();
            DoListBoxFilter('#<% = ListBox5_a.ClientID %>', filter, keys, values);

        });
	    var keys3 = [];
	    var values3 = [];
	    var options3 = $('#<% = ListBox6_a.ClientID %> option');
      ...
      $('#<% = MajorFilter3.ClientID %>').keyup(function () {
          var filter = $(this).val();
          DoListBoxFilter('#<% = ListBox6_a.ClientID %>', filter, keys, values);

      });
	    var keys4 = [];
	    var values4 = [];
	    var options4 = $('#<% = C35_Mj.ClientID %> option');

      $.each(options4, function (index, item) {
          keys4.push(item.value);
          values4.push(item.innerHTML);
      });

      $('#<% = MajorFilter4.ClientID %>').keyup(function () {
          var filter = $(this).val();
          DoListBoxFilter('#<% = C35_Mj.ClientID %>', filter, keys, values);
	        ...
	        if (Major1) {
	            $.ajax({
	                ...
	                success: function (data) {
	                    ...
	                    $('#C35_R').prop('checked', false);
	                    $('#C35_RB').prop('checked', false);
	                }
	            });
	        } else {
	            $('#C35_SMj').html('<option value="">Select Major Group</option>');
	        }
	    });
	    ...
	    $('#C35_U').bind('change', function () {
	        ...
	        //alert("ds");
	        $('#C35_Code').val(Unit1);
	        $('#C35_Code').css('background', 'green');
	        $('#C35_Code').css('color', 'white');
	                ...
	                success: function (data) {
	                    ...
	                    if (data != "") {
	                        ...
	                        if (dataLen > 0) {
	                            ...
	                            $('#C35_Min').html('');
	                            $('#C35_U').html('');
	                            $('#C35_Code').css('border-color', 'green');
	                            $('#C35_Code').css('background', 'green');
	                            $('#C35_Code').css('color', 'white');
	                        ...
	                        $('#C35_Code').css('border-color', 'red');
	                        $('#C35_Code').css('background', 'red');
	                        $('#C35_Code').css('color', 'white');
	                    }
	                }
	            });
