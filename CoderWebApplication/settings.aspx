<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="settings.aspx.cs" Inherits="CoderWebApplication.WebFormSettings" %>
<!doctype html>
    ...
    <aside id="sidebar">
    	...
    	<nav id="nav">
	    	<ul class="menu collapsible shadow-bottom">
	    		...
	    		</li><li><a href="settings.aspx" class="current"><img src="img/icons/packs/fugue/16x16/ui-tab-content.png">Settings</a></li>
    ...
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<% if (Request["updated"]=="1")
                ...
                {%>
			<div class="alert success"><strong>Settings Updated Successfully Compeleted!</strong></div>			
			<% } %>	
			<div class="grid_12">
				<h1>Settings</h1>
				</div>
			...
			<div class="grid_12">
				<div class="block-border">
					<div class="block-content">
						...
						<div class="_100">
							<p><label for="textfield">Batch Size</label>
                                <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
							</p>
						</div>
						<div class="_100">
							<p><label for="textfield">Sampling Percentage</label>
                                <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
							</p>
						</div>
                            <div class="_100">
							<p><label for="textfield">Matching Threshold Percentage</label>
						...
						<div class="block-actions">
							...
							<ul class="actions-right">
                                <li><asp:Button ID="Button1" class="button"  runat="server" Text="Update Settings" OnClick="Button1_Click1" /></li>
							</ul>
						</div>
					</form>
						  <div class="clear"></div>
