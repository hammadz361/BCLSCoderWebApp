<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="view_user.aspx.cs" Inherits="CoderWebApplication.WebFormViewUser" %>
<!doctype html>
    ...
    <aside id="sidebar">
    	...
    	<nav id="nav">
	    	<ul class="menu collapsible shadow-bottom">
	    		...
	    		<li>
	    			<a href="javascript:void(0);" class="current"><img src="img/icons/packs/fugue/16x16/clipboard-list.png">Users</a>
	    			<ul class="sub">
    ...
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<% if (Request["updated"]=="1")
                ...
                {%>
			<div class="alert success"><strong>User Updated Successfully!</strong></div>			
			<% } %>	
			<div class="grid_12">
				<h1>View User</h1>
				</div>
			...
			<div class="grid_12">
				<div class="block-border">
					<div class="block-content">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" EnableModelValidation="True" GridLines="None">
                            <Columns>
                                <asp:BoundField DataField="username" HeaderText="username" SortExpression="username" />
                                <asp:BoundField DataField="TotalBatches" HeaderText="TotalBatches" ReadOnly="True" SortExpression="TotalBatches" />
                                <asp:BoundField DataField="TotalCodedEntries" HeaderText="TotalCodedEntries" ReadOnly="True" SortExpression="TotalCodedEntries" />
                                <asp:BoundField DataField="Type" HeaderText="Type" ReadOnly="True" SortExpression="Type" />
                                <asp:HyperLinkField DataNavigateUrlFields="user_id" DataNavigateUrlFormatString="edit_user.aspx?id={0}" Text="Edit" />
                                <asp:HyperLinkField DataNavigateUrlFields="user_id" DataNavigateUrlFormatString="view_details.aspx?type=batches&id={0}" Text="View Batches" />
                            </Columns>
