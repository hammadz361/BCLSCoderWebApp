<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CorrectedText.aspx.cs" Inherits="CoderWebApplication.CorrectedText" %>
<!doctype html>
			...
			<div class="grid_12">
				<div class="block-border">
					<div class="block-content">
						...
						<div class="_100">
							<p><label for="textfield">Upload File <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></label>
                                <asp:FileUpload ID="FileUpload1" runat="server" />
                                <asp:GridView ID="GridView1" runat="server"></asp:GridView>
							</p>
						</div>
                           <div class="_100">
							<p><label for="textfield">Type:<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></label>
                                <asp:DropDownList ID="category" runat="server">
                                    <asp:ListItem>Please Select Category</asp:ListItem>
                                    <asp:ListItem>Industries</asp:ListItem>
                                    <asp:ListItem>Occupations</asp:ListItem>
						...
						<div class="block-actions">
							...
							<ul class="actions-right">
                                <li><asp:Button ID="Button1" class="button"  runat="server" Text="Upload" OnClick="Button1_Click1" /></li>
							</ul>
						</div>
					</form>
						  <div class="clear"></div>
