<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="view_details.aspx.cs" Inherits="CoderWebApplication.WebFormViewBatch" %>
<!doctype html>
  ...
  <div id="container">
    ...
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>View Batches - <asp:Label ID="Label1" runat="server" Text="Accepted Batches"></asp:Label></h1>
				</div>
...
<select onchange="window.location=this.options[this.selectedIndex].value;">
 ...
 <option value="view_details.aspx?type=acceptedbatchesocc">Accepted Batches Occupation</option>
 <option value="view_details.aspx?type=rejectedbatchesocc">Rejected Batches Occupation</option>
    <option value="view_details.aspx?type=acceptedbatchesind">Accepted Batches Industries</option>
 <option value="view_details.aspx?type=rejectedbatchesind">Rejected Batches Industries</option>
    <option value="view_details.aspx?type=acceptedbatchestools">Accepted Batches Tools</option>
 <option value="view_details.aspx?type=rejectedbatchestools">Rejected Batches Tools</option>
 ...
 <option value="view_codes.aspx?type=alloccupations&BatchID=AllOccupations">All Codes (Occupations)</option>
			...
			<div class="grid_12">
				<div class="block-border">
					<div class="block-content">
                        <asp:GridView ID="GridView2" style="width:98%" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" EnableModelValidation="True" OnPageIndexChanging="OnPaging"  PagerSettings-PageButtonCount="25" PageSize="25">
                            <Columns>
                                <asp:BoundField DataField="BatchID" HeaderText="BatchID" ReadOnly="True" SortExpression="BatchID" />
                                <asp:BoundField DataField="Type" HeaderText="Type" ReadOnly="True" SortExpression="Type" />
                                <asp:BoundField DataField="Total Codes" HeaderText="Total Codes" ReadOnly="True" SortExpression="Total Codes" />
                                <asp:BoundField DataField="Total Reviewed" HeaderText="Total Reviewed" ReadOnly="True" SortExpression="Total Reviewed" />                                
                                 <asp:BoundField DataField="Review Date" HeaderText="Review Date" ReadOnly="True" SortExpression="Review Date" />
                                <asp:BoundField DataField="Acception Percentage" HeaderText="Acception Percentage" ReadOnly="True" SortExpression="Acception Percentage" />
                                <asp:BoundField DataField="BatchStatus" HeaderText="BatchStatus" ReadOnly="True" SortExpression="BatchStatus" />

                                <asp:HyperLinkField DataNavigateUrlFields="Type,BatchID,BatchStatus" DataNavigateUrlFormatString="view_codes.aspx?type={0}&amp;BatchID={1}"  HeaderText="View" Text="View Codes" />
                            </Columns>

<PagerSettings PageButtonCount="25"></PagerSettings>
