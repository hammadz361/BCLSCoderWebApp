<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="add_user.aspx.cs" Inherits="CoderWebApplication.WebFormAddUser" %>
<!doctype html>
					...
					<div class="block-content">
						...
						<div class="block-actions">
							...
							<ul class="actions-right">
                                <li><asp:Button ID="Button1" class="button"  runat="server" Text="Add User" OnClick="Button1_Click1" /></li>
							</ul>
						</div>
					</form>
						  <div class="clear"></div>
