<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="supervisor.aspx.cs" Inherits="CoderWebApplication.WebFormsupervisor" %>
<!doctype html>
  ...
  <div id="container">
    ...
    <aside id="sidebar">
		...
		<section id="login-details">
    		<img class="img-left framed" src="img/misc/avatar_small.png" style="height: 55px;" style="height: 55px;" alt="Hello Admin">
    		<h3>Logged in as</h3>
    	...
    	<nav id="nav">
	    	<ul class="menu collapsible shadow-bottom">
	    		<li><a href="supervisor.aspx" class="current"><img src="img/icons/packs/fugue/16x16/dashboard.png">Dashboard</a></li>
               ...
               <li><a href="CorrectedText.aspx"><img src="img/icons/packs/fugue/16x16/dashboard.png">Corrected Text</a></li>
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				<li><a href="supervisor.aspx" title="Home"><span id="bc-home"></span></a></li>
		...
		<div id="main-content">
			...
			<div class="alert success"><strong>Batch Compeleted!</strong></div>		
                ...
                <% } %>	
                    ...
                    <div class="grid_12" runat="server">
				<div class="block-border">
					<div class="block-header">
						<h1>Overview-List</h1><span></span>
					</div>
					<div class="block-content">
               <asp:GridView CssClass="table table-hover"   runat="server" ID="summary" AutoGenerateColumns="true">
			...
			<%--	<div class="grid_12">
				<div class="block-border">
					...
					<ul class="overview-list">
							<li><a href="javascript:void(0);"><span><asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></span> Total Batches</a></li>
                            <li><a href="javascript:void(0);"><span><asp:Label ID="Label3" runat="server" Text="Label"></asp:Label></span> Total InProgress Batches</a></li>
                            <li><a href="javascript:void(0);"><span><asp:Label ID="Label4" runat="server" Text="Label"></asp:Label></span> Total Pending Re-Coding</a></li>
							<li><a href="javascript:void(0);"><span><asp:Label ID="Label5" runat="server" Text="Label"></asp:Label></span> Total Accepted</a></li>
							<li><a href="javascript:void(0);"><span><asp:Label ID="Label6" runat="server" Text="Label"></asp:Label></span> Total Rejected</a></li>
						</ul>
					</div>
				</div>
			</div>
