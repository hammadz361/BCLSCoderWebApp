<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="CoderWebApplication.WebFormAdmin" %>
<!doctype html>
    ...
    <aside id="sidebar">
    	...
    	<nav id="nav">
	    	<ul class="menu collapsible shadow-bottom">
	    		<li><a href="admin.aspx" class="current"><img src="img/icons/packs/crystal/48x48/apps/demo.png">Dashboard</a></li>
	    		<li>
	    			<a href="javascript:void(0);"><img src="img/icons/packs/crystal/48x48/apps/access.png">Users</a>
	    			<ul class="sub">
	    				<li><a href="add_user.aspx">Add New User</a></li>
	    				<li><a href="view_user.aspx">View Users</a></li>
	    			</ul>
	    		</li>
                <li><a href="settings.aspx"><img src="img/icons/packs/crystal/48x48/apps/Session Manager.png">Settings</a></li>
	    		
                <li>
	    			<a href="javascript:void(0);"><img src="img/icons/packs/crystal/48x48/apps/Volume Manager.png">Reports</a>
	    			<ul class="sub">
