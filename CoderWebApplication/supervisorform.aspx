<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="supervisorform.aspx.cs" Inherits="CoderWebApplication.WebFormcodeWebFormcode01a" %>
<!doctype html>
...
If did not work last week but usually has a job: Where does (NAME) usually carry out his/her job?"></asp:TextBox>
                            ...
                            <div class="_25">
								<p><label for="textfield2">Minor Group</label>
                                    <asp:ListBox ID="ListBox1_c"  style="height:150px !important" runat="server"></asp:ListBox></p>
							</div>
                            <div class="_25">
								<p><label for="textfield2">Unit Group</label>
                                    <asp:ListBox ID="ListBox1_d"  style="height:150px !important" runat="server"></asp:ListBox></p>
							</div>
                                </div>
                            <div class="_100">
                             <div class="_50">
