<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="edit_user.aspx.cs" Inherits="CoderWebApplication.WebFormEditUser" %>
<!doctype html>
			...
			<div class="grid_12">
				<div class="block-border">
					<div class="block-content">
						...
						<div class="_100">
							<p><label for="textfield">UserName</label>
                                <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
							</p>
						</div>
						
						<div class="_100">
							<p><label for="textarea">Password</label>
						...
						<div class="_100">
							<p>
                                ...
                                <asp:ListItem runat="server" text="Coder" value="3"></asp:ListItem>
                                    
                                <asp:ListItem runat="server" text="Supervisor" value="2"></asp:ListItem>
						...
						<div class="block-actions">
							...
							<ul class="actions-right">
                                <li><asp:Button ID="Button1" class="button"  runat="server" Text="Update User" OnClick="Button1_Click1" /></li>
							</ul>
						</div>
					</form>
						  <div class="clear"></div>
