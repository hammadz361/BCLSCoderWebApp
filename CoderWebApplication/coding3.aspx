<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="coding3.aspx.cs" Inherits="CoderWebApplication.WebFormcode03" %>
<!doctype html>
				...
				<div class="block-border">
					...
					<form id="form1" class="block-content form" defaultbutton="Button1" runat="server">
						...
						<fieldset>
                           ...
                           <div class="_50">
								<p><label for="textfield2">C38_3c_11</label>
                                    <asp:TextBox ID="TextBoxC38c" runat="server" disabled="true" CssClass="act_text" TextMode="MultiLine" style="resize:none"  ToolTip="C38_3c_11 C38c. Is the tool/equipment you are describing …” to the information displayed for the coding of tools.?"></asp:TextBox></p>
							</div> <div class="_100">
...
C38_3_11_59 'C38b. What do you do with the tool/equipment and what is the material/object you are working/processing?'"></asp:TextBox></p>
                            ...
                            <div class="_25">
								<p><label for="textfield2">Major Group</label>
                                    ...
                                    <asp:ListBox ID="ListBox1" runat="server"  style="height:150px !important"></asp:ListBox>
                                    </p>
							</div>
                            <div class="_25">
								<p><label for="textfield2">Sub-Major Group</label>
                                    <asp:ListBox ID="ListBox2" runat="server"  style="height:150px !important">
                                    </asp:ListBox></p>
							</div>
                            <div class="_25">
								<p><label for="textfield2">Minor Group</label>
                                    <asp:ListBox ID="ListBox3" runat="server"  style="height:150px !important"></asp:ListBox></p>
							</div>
                            <div class="_25">
								<p><label for="textfield2">Unit Group</label>
                                    <asp:ListBox ID="ListBox4" runat="server"  style="height:150px !important"></asp:ListBox></p>
							</div>
                             <div class="_25">
                            <p>
                            ...
                            <div class="_50">
								<p><label for="textfield1">Code2</label>
                                    <asp:TextBox ID="TextBox2" runat="server" ToolTip="C38_1_11_59 C38. What type of tools, equipment or machines do you use at work? 
C38_2_11_59 C38a. What is the name of the tool/machine/equipment?
C38_3_11_59 'C38b. What do you do with the tool/equipment and what is the material/object you are working/processing?'"></asp:TextBox></p>
							</div>
  ...
  <script type="text/javascript">
      opts = document.getElementById("ListBox7_a").getElementsByTagName("option")
      for (var k = 0; k < opts.length; k++) {
          opts[k].title = opts[k].text
      }
      opts2 = document.getElementById("ListBox1").getElementsByTagName("option")
  ...
  <script type="text/javascript">
      ...
      $().ready(function () {
          ...
          var keys = [];
          var values = [];
          var options = $('#<% = ListBox7_a.ClientID %> option');
        ...
        $('#<% = MajorFilter1.ClientID %>').keyup(function () {
          var filter = $(this).val();
          DoListBoxFilter('#<% = ListBox7_a.ClientID %>', filter, keys, values);

      });
      var keys2 = [];
      var values2 = [];
      var options2 = $('#<% = ListBox1.ClientID %> option');
              ...
              if (Major1) {
                  $.ajax({
                      ...
                      success: function (data) {
                          ...
                          $('#radio77').prop('checked', false);
                          $('#radio77_b').prop('checked', false);
                      }
                  });
              } else {
